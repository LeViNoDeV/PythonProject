...
def startbuttonlmachine1(x,y):
    ...
    import runpy
    file_globals = runpy.run_path('slot/lmachine.py')
...
def startbuttoncardwar(x,y):
    ...
    roulette1.ht()
    import runpy
    file_globals = runpy.run_path(r"projecy\cardwar.py")
...
def startbuttonroulettegame(x,y):
    ...
    import runpy
    file_globals = runpy.run_path(r"roulette\roulette.py")
...
def startbuttonhorsegame(x,y):
    ...
    horserace.ht()
    import runpy
    file_globals = runpy.run_path(r"racegameadam\.py")
